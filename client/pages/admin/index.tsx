...
export default function Loading({ }: Props) {
  ...
  return (
    <div>
      <div className='w-full text-center text-2xl font-semibold p-16'>Profile Management</div>
      <form className="w-full max-w-sm mx-auto border-2 border-gray-300 py-10 px-10">
